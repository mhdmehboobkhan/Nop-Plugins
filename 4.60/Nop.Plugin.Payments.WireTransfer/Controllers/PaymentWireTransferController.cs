...
namespace Nop.Plugin.Payments.WireTransfer.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class PaymentWireTransferController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentWireTransferController(ILanguageService languageService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var checkMoneyOrderPaymentSettings = await _settingService.LoadSettingAsync<WireTransferPaymentSettings>(storeScope);
            ...
            return View("~/Plugins/Payments.WireTransfer/Views/Configure.cshtml", model);
        }
